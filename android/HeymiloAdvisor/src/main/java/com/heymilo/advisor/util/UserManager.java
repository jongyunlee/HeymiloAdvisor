...
public class UserManager {
    ...
    public static final String keys2Kind = "keys2Kind";
    public static final String keys2TimeError = "keysTimeError";
    public static final String keys2Weight = "keys2Weight";
    public static final String keys2Age = "keys2Age";
    ...
    public static String getKind(Context context) {
	return getStringValue(context, keys2Kind);
    }

    public static int getWeight(Context context) {
	return getIntegerValue(context, keys2Weight);
    }

    public static int getAge(Context context) {
	return getIntegerValue(context, keys2Age);
    }
    ...
    public static void setKind(Context context, String name) {
	saveStringValue(context, keys2Kind, name);
    }

    public static void setWeight(Context context, int weight) {
	saveIntegerValue(context, keys2Weight, weight);
    }

    public static void setAge(Context context, int age) {
	saveIntegerValue(context, keys2Age, age);
    }
